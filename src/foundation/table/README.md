...
>
> **Change summary:** Chuẩn hóa table shell, fixed column width, horizontal scroll, pagination và action icon dùng chung toàn Admin.
...
- Pagination mặc định 20 dòng và có lựa chọn 20/50/100; server pagination của feature vẫn là nguồn dữ liệu chính.
