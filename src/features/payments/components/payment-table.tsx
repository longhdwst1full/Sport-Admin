...
export function PaymentTable({
  ...
  return (
    <Table
      ...
      columns={[
        { title: 'Mã thanh toán', dataIndex: 'paymentRef', fixed: 'left', width: 190, render: (value) => <Typography.Text strong copyable>{value}</Typography.Text> },
        { title: 'Đơn hàng', dataIndex: 'orderNo', width: 180, render: (value) => <Typography.Text copyable>{value}</Typography.Text> },
