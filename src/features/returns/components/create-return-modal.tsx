...
import type { ReturnDetailDto, ReturnEligibilityDto } from '@/generated/api/returns/models';
      ...
      >
        ...
        <Table
          ...
          columns={[
            ...
            { title: 'Đã mua', dataIndex: 'purchasedQuantity', width: 80 },
            { title: 'Còn trả được', dataIndex: 'returnableQuantity', width: 110 },
            {
              title: 'Số trả',
              width: 130,
              render: (_, line) => {
